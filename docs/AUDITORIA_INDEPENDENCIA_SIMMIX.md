...
Comparación marca × canal y marca × modelo contra el export Simmix de cierre de julio (enero-julio 2026). Total mercado: ETL 869.560 vs Simmix 869.629 (-69, -0,01%). Focus Segment (BMW/MINI/Audi/Mercedes/Porsche/Volvo/Lexus/Land Rover/Genesis/Maserati/Ferrari/Lamborghini/Bentley/Rolls-Royce/McLaren/Aston Martin/Cadillac/Tesla/Polestar/Lotus/Smart/Xpeng/Zeekr): ETL 132.246 vs Simmix 132.207 (+39, +0,03%) tras los fixes de este apartado.

**Corregido** (`masters/master_clasificacion_manual.csv`, `scripts/process_month.py`):
- Rolls-Royce (Cullinan/Wraith/Spectre/Ghost/Phantom/Dawn) no estaba en ningún maestro → cae en REST por defecto. Simmix los clasifica como FOCUS SEGMENT. Añadidas 10 entradas.
